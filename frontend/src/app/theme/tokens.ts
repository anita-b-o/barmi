...
const rawColors = {
  ...
  oceanBrand: '#0E7490',
  oceanAccent: '#2563EB',
  oceanActionHover: '#155E75',
  oceanSurfaceTint: '#ECFEFF',
  oceanBorderAccent: '#67E8F9',
  forestBrand: '#15803D',
  forestAccent: '#65A30D',
  forestAction: '#166534',
  forestActionHover: '#14532D',
  forestSurfaceTint: '#F0FDF4',
  forestBorderAccent: '#86EFAC',
  graphiteBrand: '#374151',
  graphiteAccent: '#111827',
  graphiteAction: '#1F2937',
  graphiteSurfaceTint: '#F3F4F6',
  graphiteBorderAccent: '#9CA3AF',
  coralSurfaceTint: '#FFF1EF',
  coralBorderAccent: '#F7B3AC',
