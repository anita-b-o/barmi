  ...
  return (
    <Card
      style={{
        ...
        padding: viewportMode === 'mobile' ? theme.spacing.xl : undefined,
    ...
    >
      ...
      >
        ...
        {couponPreview.message ? (
          <div
            style={{
              color: couponPreview.status === 'valid' ? theme.colors.success : theme.colors.error,
              padding: theme.spacing.md,
              borderRadius: theme.radius.md,
              background: alpha(couponPreview.status === 'valid' ? theme.colors.success : theme.colors.error, 0.1),
              border: `1px solid ${alpha(couponPreview.status === 'valid' ? theme.colors.success : theme.colors.error, 0.2)}`,
              boxShadow: 'none'
            }}
          >
            {couponPreview.message}
      ...
      >
        ...
        >
          ...
          <strong style={{ fontSize: theme.typography.display.size, lineHeight: 1, color: theme.colors.textPrimary, minWidth: 0, overflowWrap: 'anywhere', textAlign: 'right', marginLeft: 'auto' }}>
